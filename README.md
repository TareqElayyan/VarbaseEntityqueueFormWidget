...
```
composer create-project Vardot/varbase-build:8.x VarbaseEntityqueueFormWidget --stability dev --no-interaction
```
...
Go to [ VarbaseEntityqueueFormWidget/docroot/profiles/varbase ] in the terminal then you could run the following command:
```
...
[ VarbaseEntityqueueFormWidget/docroot/profiles/varbase/tests/reports ]
