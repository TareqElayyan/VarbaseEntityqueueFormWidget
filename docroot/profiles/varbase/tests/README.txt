...
```
composer create-project Vardot/varbase-build:8.4.0-beta5 VarbaseEntityqueueFormWidget --stability beta --no-interaction
```
...
Then go to [ VarbaseEntityqueueFormWidget/docroot/profiles/varbase ] in the
terminal then you could run the following command:

```
$ ../../../bin/behat tests/features/varbase
```
4. Run the behat command at VarbaseEntityqueueFormWidget/docroot/profiles/varbase/testes
...
6. To see the report in HTML. Go and open this file in a browser.
    VarbaseEntityqueueFormWidget/docroot/profiles/varbase/tests/reports/index.html
...
```
    After that you can see the report in the VarbaseEntityqueueFormWidget/docroot/profiles/varbase/tests/reports folder.
